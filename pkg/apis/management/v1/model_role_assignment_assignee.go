...
// checks if the RoleAssignmentAssignee type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleAssignmentAssignee{}
...
type _RoleAssignmentAssignee RoleAssignmentAssignee

// NewRoleAssignmentAssignee instantiates a new RoleAssignmentAssignee object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRoleAssignmentAssignee(user string, role string, type_ string) *RoleAssignmentAssignee {
...
func (o *RoleAssignmentAssignee) GetUser() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *RoleAssignmentAssignee) GetUserOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.User, true
...
func (o *RoleAssignmentAssignee) SetUser(v string) {
	o.User = v
}

// GetRole returns the Role field value
func (o *RoleAssignmentAssignee) GetRole() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RoleAssignmentAssignee) GetRoleOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Role, true
...
func (o *RoleAssignmentAssignee) SetRole(v string) {
	o.Role = v
}
...
func (o RoleAssignmentAssignee) ToMap() (map[string]interface{}, error) {
...
func (o *RoleAssignmentAssignee) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleAssignmentAssignee := _RoleAssignmentAssignee{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoleAssignmentAssignee)

	if err != nil {
		return err
	}

	*o = RoleAssignmentAssignee(varRoleAssignmentAssignee)
